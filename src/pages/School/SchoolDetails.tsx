...
export default function SchoolDetails() {
    ...
    const loadData = () => {
        if (id) {
            ...
            Promise.all([
                ...
                setError(normalizeError(err, "We couldn’t fetch school details from the API. Please try again."));
                setIsLoading(false);
            });
        }
    };
    ...
    if (error) return <ErrorState title="Unable to load school details" message={error} variant="page" onRetry={loadData} showRefreshPage={true} />;
        ...
        <div className="space-y-6 pb-10">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-center text-sm text-slate-500 gap-2">
                    <button className="hover:text-slate-900" onClick={() => navigate("/dashboard")}>Home</button>
                    <span>/</span>
                    <button className="hover:text-slate-900" onClick={() => navigate("/schools")}>Schools</button>
                    <span>/</span>
